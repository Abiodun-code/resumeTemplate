...
const Box = () => {
  ...
  return (
    <div className='Box' data-aos-duration='2000' data-aos="fade-down">
      <div className="Box_shift">

        <div className="Box_image">
          <img src="/assets/img_avatar.png" alt="olaroungbe" className="w-full"></img>
        </div>

        <div className="Box_text_first">
          <h1>Olaroungbe Jamiu</h1>
          <p>
            <Typewriter
              onInit={(typewriter) => {
                typewriter
                  .typeString("I'm a Mobile developer")
                  .pauseFor(1000)
                  .deleteAll()
          ...
          <button className='Box_a' data-aos="zoom-in" data-aos-duration="2000">
            <a href="./assets/Olapd.pdf">Download Resume</a>
          </button>
          <ul className='Box_ul'>
            <li className='Box_li' data-aos="fade-up" data-aos-duration="2000"><a href="https://github.com/Abiodun-code/">
            ...
            <li className='Box_li' data-aos="fade-up" data-aos-duration="2000"><a href="https://www.linkedin.com/in/olaroungbe-jamiu-1125b2225/">
            ...
            <li className='Box_li' data-aos="fade-up" data-aos-duration="2000"><a href="">
