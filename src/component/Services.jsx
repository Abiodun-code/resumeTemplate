    ...
    <div className='Services'>
      <div className="Services_wrap">
        <div className="Service_first">
          <div className="Serv_first_card" data-aos="zoom-in" data-aos-duration="2000">
            <div className="Serv_first_svg">
            ...
            <div className="Serv_first_text">
              <h1>Web Developer</h1>
              <p>a person or company that develops World Wide Web software applications, or that creates and maintains websites.</p>
            </div>
          </div>
          <div className="Serv_first_card" data-aos="zoom-in" data-aos-duration="2000">
            <div className="Serv_first_svg">  
          ...
          <div className="Serv_first_card" data-aos="zoom-in" data-aos-duration="2000">
            <div className="Serv_first_svg">
              <svg stroke="currentColor" fill="currentColor" xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
        ...
        <div className="Service_second">
          <div className="Serv_second_card" data-aos="zoom-in" data-aos-duration="2000">
            <div className="Serv_second_svg">
            ...
            <div className="Serv_second_text">
              <h1>React</h1>
          ...
          <div className="Serv_second_card" data-aos="zoom-in" data-aos-duration="2000">
            ...
            <div className="Serv_second_text">
              <h1>Flutter</h1>
              <p>Flutter is an open-source UI software development kit created by Google. It is used to develop cross platform applications for Android, iOS, Linux, macOS, Windows, Google Fuchsia</p>
            </div>
          </div>
          <div className="Serv_second_card" data-aos="zoom-in" data-aos-duration="2000">
            <div className="Serv_second_svg">
            ...
            <div className="Serv_second_text">
              <h1>Git & GitHub</h1>
              <p>GitHub is where over 83 million developers shape the future of software, together. Contribute to the open source community, manage your Git repositories</p>
            </div>
          </div>
        </div>
      </div>
